...
Список найден по ревью сессии от 2026-07-24 (AI-генерация викторины: formset для правки вопросов + сохранение в quizzes). Обновлено по ревью сессии от 2026-07-27 — большая часть блокирующих и важных пунктов исправлена. Обновлено по ревью сессии от 2026-07-29 (коммит `d3d7e21` — login/logout, `login_required`).
